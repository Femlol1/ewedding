...
const AdminPage = () => {
	...
	const TemitopenUpdateModal = (rsvp: RSVP) => {
					...
					<tbody>
						{filteredRsvps.map((rsvp) => (
							<tr key={rsvp.id} className="border-b">
								<td className="px-4 py-2 tableNumber">
									{rsvp.tableGroupId
										? groups.find(
								...
								<td className="px-1 py-1">{rsvp.allergies}</td>
